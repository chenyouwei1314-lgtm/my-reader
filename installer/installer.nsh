!macro customInstall
  ...
  WriteRegStr HKCR "AirWeiReader.CBZ\shell\open\command" "" '"$INSTDIR\AirWeiReaderCbzLauncher.exe" "%1"'
  ...
  WriteRegStr HKCR "AirWeiReader.PDF\shell\open\command" "" '"$INSTDIR\AirWeiReaderPdfLauncher.exe" "%1"'
